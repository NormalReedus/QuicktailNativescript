<template>
	<ScrollView verticalAlign="middle">
      ...
      <Button v-for="ice of ices" :key="ice" @tap="updateIceData(ice)" :class="{ selected: iceData === ice }" class="h2 -primary -rounded-sm" flexGrow="1" height="60" width="120">{{ ice }}</Button>
  	</FlexboxLayout>
	</ScrollView>
</template>
